    ...
    SubShader
    {
      ...
      Pass
      {
        ...
        v2f vert(appdata v)
        {
          ...
          const float uvFactor = (_HeightMapSize + 1.0f) / _HeightMapSize;
          o.uv = v.uv * uvFactor;
          return o;
        }
