...
namespace UnityEngine.Rendering.LWRP
{
    ...
    internal class EnviroBlitPass : UnityEngine.Rendering.Universal.ScriptableRenderPass
    {
        ...
        public void Setup(RenderTargetIdentifier source, UnityEngine.Rendering.Universal.RenderTargetHandle destination, Material mat)
        {
            this.source = source;
        ...
        public override void Execute(ScriptableRenderContext context, ref UnityEngine.Rendering.Universal.RenderingData renderingData)
        {
            ...
            if (destination == UnityEngine.Rendering.Universal.RenderTargetHandle.CameraTarget)
            {
                ...
                { 
                  CustomBlit(cmd,source,m_TemporaryColorTexture.Identifier(),blitMaterial,blitShaderPassIndex);
                }  

                CustomBlit(cmd,m_TemporaryColorTexture.Identifier(),source);
            }
            else
            {      
                CustomBlit(cmd,source, destination.Identifier(),blitMaterial,blitShaderPassIndex);
            }
