...
/*
            ...
            else
            {
                ...
                else if (EnviroSkyMgr.instance.useDistanceBlur && EnviroSky.instance.showDistanceBlurInEditor)
                {
                    SetMatrixes();
                    RenderDistanceBlur(source, destination, cmd);
                }
        ...
        private void RenderDistanceBlur(RenderTexture source, RTHandle destination, CommandBuffer cmd)
        {
            ...
            { 
                ...
                postProcessMat.SetVector("_BaseTex_TexelSize", new Vector4(1 / basetex.width, 1 / basetex.height, basetex.width, basetex.height));
